...
// GET em /carros
router.get('/carros', async (req, res, next) => {
    let carros = await CarroDB.getCarros();
    res.json(carros);
});

// GET em /carros/id
router.get('/carros/:id(\\d+)', async (req, res, next) => {
...
// DELETE em /carros/id
router.delete('/carros/:id(\\d+)', async (req, res, next) => {
    let id = req.params.id;
...
// GET em /carros/xxx
router.get('/carros/:tipo', async (req, res, next) => {
...
router.post('/carros', async (req, res, next) => {
...
router.put('/carros', async (req, res, next) => {
    // Carro enviado no formato JSON
